...
### 9️⃣ Two-Tier Web App (EC2 + RDS)

* Deployed a 2-tier web application on AWS using modular Terraform
* VPC with public/private subnets, EC2 Flask server, and private RDS MySQL database
* Auto-generated secrets via AWS Secrets Manager — zero hardcoded passwords
* Dive into project folder to know more.
