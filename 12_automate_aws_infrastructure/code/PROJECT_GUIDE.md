# 🚀 Terraform Multi-Environment CI/CD Project Guide
...
4. [Project Scenarios](#project-scenarios)
...
# Clone repository
git clone https://github.com/33Krishna/12_automate_aws_infrastructure.git
cd 12_automate_aws_infrastructure
...
### Project Structure
```
12_automate_aws_infrastructure/
├── .github/
│   └── workflows/
