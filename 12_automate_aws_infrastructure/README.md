# AWS Production Infrastructure (Project 12)
...
This project guide walks you through deploying a production-grade 2-tier AWS infrastructure using Terraform. The infrastructure includes:
...
cd /home/33krishna/repos/terraform_projects/12_automate_aws_infrastructure
```
...
**Project costs:** If destroyed within 1 hour: ~$0.15
...
**Project Duration:** 15-20 minutes (including deployment and testing)
