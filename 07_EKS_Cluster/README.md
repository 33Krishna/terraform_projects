# EKS Cluster with Terraform (07 Project)
...
5. **aws-iam-authenticator** (optional, AWS CLI has built-in support)
...
```bash
aws eks --region us-east-1 update-kubeconfig --name 07-eks-cluster
```
