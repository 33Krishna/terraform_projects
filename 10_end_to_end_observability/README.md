# S3 Security & Operations Monitoring (Real-Time Project)

This project sets up a comprehensive monitoring stack for S3 bucket using CloudTrail, CloudWatch Logs, Metric Filters, and CloudWatch Alarms. It alerts you via email (SNS) when suspicious activity occurs.
