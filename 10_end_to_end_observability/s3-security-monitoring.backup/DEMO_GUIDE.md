...
This is your **one-stop reference guide** entire demo in one shot. Follow this sequentially from top to bottom. Every section includes what to show, what to say, and why it matters.
...
### VS Code Setup
- Open folder: `10_end_to_end_observability/s3-security-monitoring`
...
## PART 2: Introduction & Problem Statement

### What to Show
- Your face or screen with the project folder open in VS Code.

### What to Say
> "Today we're tackling a real-world security challenge: **How do you monitor your S3 buckets for suspicious activity?**
>
...
## PART 3: Architecture & Code Walkthrough
...
## PART 5: SNS Subscription Confirmation (Critical Step)
