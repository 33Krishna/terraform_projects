# Terraform Provisioners Project (Project 06)
...
This project covers the three most common provisioner types:
...
This small project shows three provisioner techniques and how to enable them one at a time for teaching:
...
2. Quick project steps (recommended flow)
...
- Clean up resources after project with `terraform destroy`
